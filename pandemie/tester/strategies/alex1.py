...
class Alex1(AbstractStrategy):
    ...
    def _solve(self, json_data):
        ...
        if self.weights:
            ...
            #{"target": 0.7099487891636155,
             measure_weights= {"apply_hygienic_measures": 0.917022004702574, "call_elections": 1.220324493442158,
                        "close_airport": 0.5001143748173449, "close_connection": 0.8023325726318398,
                        "deploy_medication": 0.646755890817113, "deploy_vaccine": 0.5923385947687978,
                        "develop_medication": 0.6862602113776709, "develop_vaccine": 0.8455607270430477,
                        "end_round": 0.8967674742306699, "exert_influence": 1.038816734003357,
                        "launch_campaign": 0.9191945144032948, "put_under_quarantine": 1.1852195003967596}
             #"datetime": {"datetime": "2020-01-12 11:57:56", "elapsed": 156.238697, "delta": 77.372688}}




            #measure_weights ={"apply_hygienic_measures": 0.5, "call_elections": 1.5, "close_airport": 1.5, "close_connection": 0.5,
            # "deploy_medication": 1.5, "deploy_vaccine": 1.5, "develop_medication": 1.5, "develop_vaccine": 1.5,
            # "end_round": 1.5, "exert_influence": 1.5, "launch_campaign": 1.5,
            # "put_under_quarantine": 1.5}
                # "datetime": {"datetime": "2020-01-12 11:24:01", "elapsed": 2577.032198,   "delta": 61.886557}
                # winrate 42%


            #measure_weights= {"apply_hygienic_measures": 1.5, "call_elections": 1.5, "close_airport": 0.5, "close_connection": 1.5,
            # "deploy_medication": 0.5, "deploy_vaccine": 0.5, "develop_medication": 1.5, "develop_vaccine": 1.5,
            # "end_round": 1.5, "exert_influence": 1.5, "launch_campaign": 0.5, "put_under_quarantine": 0.5}
             # winrate 30%
            ...
            #measure_weights = {"apply_hygienic_measures": 1.5,
            #                   "call_elections": 0.5,
            #                   "close_airport": 0.5,
            #                   "close_connection": 0.5,
            #                    "deploy_medication": 0.5,
            #                   "deploy_vaccine": 1.5,
            #                   "develop_medication": 0.5,
            #                   "develop_vaccine": 1.5,
            #                    "end_round": 0.7402009111402152,
            #                   "exert_influence": 0.5,
            #                   "launch_campaign": 1.5,
            #                    "put_under_quarantine": 1.5}
            #"datetime": {"datetime": "2020-01-12 12:44:30", "elapsed": 4750.610484, "delta": 48.603875}
            # win rate 45%
