...
def weighted_final_strategy(put_under_quarantine_weight, develop_medication_weight, deploy_medication_weight,
    ...
    weights = (put_under_quarantine_weight, develop_medication_weight, deploy_medication_weight, close_airport_weight)
    ...
    score = tester.evaluate(thread_count=10)
    enable_print()
...
def bayesian_optimization():
    ...
    minimum = 0.8
    maximum = 1.2
    pbounds = {'put_under_quarantine_weight': (minimum, maximum),
